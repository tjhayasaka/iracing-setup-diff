module Car exposing (Id, Idish(..), Car, stringifiedId, get)
...
stringifiedId maybeCar =
    case maybeCar of
        Nothing -> ""
        Just car -> String.fromInt car.id
...
get idish cars =
    case idish of
        ShortName name -> getByShortName name cars
        IdString idString -> getByIdString idString cars
        Id id -> getById id cars
